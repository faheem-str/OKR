...
{companyOKRList && companyOKRList.map((items,i)=>(
  items.type === "Objective" && (
    ...
    <div class="accordion" id="accordionExample">
      <div class="accordion-item">
        ...
        {items.key_results && items.key_results.map((subItem,subIndex)=>(
 ...
 <div class="accordion-body p0 m0 accordion-button" type="button" data-bs-toggle="collapse" data-bs-target={`#collapseIn${subIndex}`} aria-expanded="false" aria-controls="collapseOne">
 ...
 <div id={`collapseIn${subIndex}`} class="accordion-collapse collapse disIn text-start kr-dtl-title">
